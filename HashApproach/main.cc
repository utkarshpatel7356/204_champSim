...
void print_address_set_map( CACHE *cache){
    cout << "ADDRESS SET MAPPING" << endl;
    for(auto i = cache->address_set_mapping.begin(); i != cache->address_set_mapping.end(); i++){
...
int main(int argc, char** argv)
{
    ...
    print_address_set_map(&uncore.LLC);
    return 0;
}
