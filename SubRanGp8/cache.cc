#define LOCALITY 8
#define HEX1 0xFFFFFF6D //for making random 2 bits zero 0 0 0 0
...
std::pair<int, int> CACHE::check_hit(PACKET *packet)
{
    ...
    if (cache_type==IS_LLC){
      ...
      for (uint32_t way=0; way<NUM_WAY; way++) {
        way_comparisons++;//cout<<"GF"<< way_comparisons << endl;
