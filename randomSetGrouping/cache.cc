#define LOCALITY 16
#define HEX1 0xFFFFFB6D //for making random 2 bits zero 0 0 0 0
#define HEX2 0x00000002 //for making random 2 bits zero 0 0 0 1
#define HEX3 0x00000010 //for making random 2 bits zero 0 0 1 0
#define HEX4 0x00000012 //for making random 2 bits zero 0 0 1 1
#define HEX5 0x00000080 //for making random 2 bits zero 0 1 0 0
#define HEX6 0x00000082 //for making random 2 bits zero 0 1 0 1
#define HEX7 0x00000090 //for making random 2 bits zero 0 1 1 0
#define HEX8 0x00000092 //for making random 2 bits zero 0 1 1 1
#define HEX9 0x00000400 //for making random 2 bits zero 1 0 0 0
#define HEX10 0x00000402 //for making random 2 bits zero 1 0 0 1
#define HEX11 0x00000410 //for making random 2 bits zero 1 0 1 0
#define HEX12 0x00000412 //for making random 2 bits zero 1 0 1 1
#define HEX13 0x00000480 //for making random 2 bits zero 1 1 0 0
#define HEX14 0x00000482 //for making random 2 bits zero 1 1 0 1
#define HEX15 0x00000490 //for making random 2 bits zero 1 1 1 0
#define HEX16 0x00000492 //for making random 2 bits zero 1 1 1 1
#include <iostream>
#include <vector>
#include <algorithm>
#include <utility>
