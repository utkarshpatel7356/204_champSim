#define LOCALITY 8
#define HEX1 0xFFFFFEB7 //for making random 2 bits zero 0 0 0
#define HEX2 0x00000008 //for making random 2 bits zero 0 0 1
#define HEX3 0x00000100 //for making random 2 bits zero 1 0 0
#define HEX4 0x00000108 //for making random 2 bits zero 1 0 1
#define HEX5 0x00000040 //for making random 2 bits zero 0 1 0
#define HEX6 0x00000048 //for making random 2 bits zero 0 1 1
#define HEX7 0x00000140 //for making random 2 bits zero 1 1 0
#define HEX8 0x00000148 //for making random 2 bits zero 1 1 1
#include <iostream>
#include <vector>
#include <algorithm>
#include <utility>
...
uint32_t CACHE::get_set_redirect(uint64_t address)//gives the redirected set location
{
  ...
  if(cache_type == IS_LLC)
  {
    ...
    int set7=set1 | HEX7;
    int set8=set1 | HEX8;
    //return set with minimum temp_evictions
    if(temp_evictions[set1]<=temp_evictions[set2] && temp_evictions[set1]<=temp_evictions[set3] && temp_evictions[set1]<=temp_evictions[set4] && temp_evictions[set1]<=temp_evictions[set5] && temp_evictions[set1]<=temp_evictions[set6] && temp_evictions[set1]<=temp_evictions[set7] && temp_evictions[set1]<=temp_evictions[set8])
    {
      temp_evictions[set1]++;
      return set1;
    }
    else if(temp_evictions[set2]<=temp_evictions[set1] && temp_evictions[set2]<=temp_evictions[set3] && temp_evictions[set2]<=temp_evictions[set4] && temp_evictions[set2]<=temp_evictions[set5] && temp_evictions[set2]<=temp_evictions[set6] && temp_evictions[set2]<=temp_evictions[set7] && temp_evictions[set2]<=temp_evictions[set8])
    {
      temp_evictions[set2]++;
      return set2;
    }
    else if(temp_evictions[set3]<=temp_evictions[set1] && temp_evictions[set3]<=temp_evictions[set2] && temp_evictions[set3]<=temp_evictions[set4] && temp_evictions[set3]<=temp_evictions[set5] && temp_evictions[set3]<=temp_evictions[set6] && temp_evictions[set3]<=temp_evictions[set7] && temp_evictions[set3]<=temp_evictions[set8])
    {
      temp_evictions[set3]++;
      return set3;
    }
    else if(temp_evictions[set4]<=temp_evictions[set1] && temp_evictions[set4]<=temp_evictions[set2] && temp_evictions[set4]<=temp_evictions[set3] && temp_evictions[set4]<=temp_evictions[set5] && temp_evictions[set4]<=temp_evictions[set6] && temp_evictions[set4]<=temp_evictions[set7] && temp_evictions[set4]<=temp_evictions[set8])
    {
      temp_evictions[set4]++;
      return set4;
    }
    else if(temp_evictions[set5]<=temp_evictions[set1] && temp_evictions[set5]<=temp_evictions[set2] && temp_evictions[set5]<=temp_evictions[set3] && temp_evictions[set5]<=temp_evictions[set4] && temp_evictions[set5]<=temp_evictions[set6] && temp_evictions[set5]<=temp_evictions[set7] && temp_evictions[set5]<=temp_evictions[set8])
    {
      temp_evictions[set5]++;
      return set5;
    }
    else if(temp_evictions[set6]<=temp_evictions[set1] && temp_evictions[set6]<=temp_evictions[set2] && temp_evictions[set6]<=temp_evictions[set3] && temp_evictions[set6]<=temp_evictions[set4] && temp_evictions[set6]<=temp_evictions[set5] && temp_evictions[set6]<=temp_evictions[set7] && temp_evictions[set6]<=temp_evictions[set8])
    {
      temp_evictions[set6]++;
      return set6;
    }
    else if(temp_evictions[set7]<=temp_evictions[set1] && temp_evictions[set7]<=temp_evictions[set2] && temp_evictions[set7]<=temp_evictions[set3] && temp_evictions[set7]<=temp_evictions[set4] && temp_evictions[set7]<=temp_evictions[set5] && temp_evictions[set7]<=temp_evictions[set6] && temp_evictions[set7]<=temp_evictions[set8])
    {
      temp_evictions[set7]++;
      return set7;
    }
