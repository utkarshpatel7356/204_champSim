...
void CACHE::print_set_type(){
    ...
    {
         v.push_back(make_pair(temp_evictions[i],i));
    }
    sort(v.begin(),v.end());
    int i=v.size()-1;
    int j=512;
    while(j--)
    {
       cout<<"Set "<<v[i].second<<" Very hot set with "<<v[i].first<<" evictions\n";
       i--;
    }
    j=512;
    while(j--)
    {
       cout<<"Set "<<v[i].second<<" Hot set with "<<v[i].first<<" evictions\n";
       i--;
    }
    j=512;
    while(j--)
    {
       cout<<"Set "<<v[i].second<<" Cold set with "<<v[i].first<<" evictions\n";
       i--;
    }
    j=512;
    while(j--)
    {
       cout<<"Set "<<v[i].second<<" Very Cold set with "<<v[i].first<<" evictions\n";
       i--;
    }
}
